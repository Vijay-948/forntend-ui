    ...
    <div className="verification-page py-40">
      ...
      <div className="flex justify-center">
        <OtpInput 
          value={otp}
          inputType="text"
          inputStyle={{width: '5.2vh', height: '6.2vh', margin: '5px', border: 'solid gray 1px'}}
          onChange={setOtp}
          numInputs={6}
      ...
      <p className="text-center text-sm mt-10">
        Didn't get a code? {'     '} 
        <a onClick={handleResendOTP} style={{color: 'red', marginLeft: '8px', cursor:'pointer'}}>Resend OTP</a>
      </p>
      ...
      <div className="flex justify-center mt-10">
        <button onClick={verifyOtpAuth} className="px-5 py-2 bg-red-500 text-white rounded-full">Verify OTP</button>
      </div>
